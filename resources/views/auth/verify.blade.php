                    ...
                    <div class="breadscrumb-contain breadscrumb-order">
                        <div class="order-box">
                                ...
                                @if (session('resent'))
                                    <div class="alert alert-success alert-dismissible" role="alert">
                                        ...
                                        <div class="alert-message">
                                            <strong>Sukses!</strong> Link verifikasi berhasil dikirim ulang. Silahkan
                                            cek email anda
                                        </div>
                                    </div>
                                @endif
                            ...
                            <div class="order-contain">
                                <h3 class="theme-color">Verifikasi Email Anda</h3>
                                <h5 class="text-content">Untuk login, anda harus verifikasi email terlebih dahulu.</h5>
                                <form class="d-flex flex-row justify-content-center" method="POST"
                                      action="{{ route('verification.resend') }}">
                                    @csrf
                                    <button type="submit"
                                            class="btn btn-link p-0 m-0">Kirim ulang link verifikasi
                                    </button>
                                    .
                                </form>
                            </div>
