...
<div style="max-width: 600px; margin: 0 auto; font-family: Arial, sans-serif;">
    <div style="border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
        <div style="background-color: #f8f9fa; padding: 10px;">
            <img src="http://127.0.0.1:200/storage/site_setting/profil-kodelisensi-2024-06-05-11-57-39.jpg" alt="Logo"
                style="width: 100%; height: auto;">
        </div>
        <div style="padding: 20px;">
            <div class="" style="display: flex; justify-content:space-between;">
                <h2 style="font-weight: bold; color: #007bff;">Terima Kasih</h2>
                <p style="margin-top:1.5rem;">No. Invoice: <strong>{{ $data['invoice_id'] }}</strong></p>
            </div>
