                                            ...
                                            <tr>
                                                <td
                                                    ...
                                                    <p
                                                        ...
                                                        selesaikan tagihan pembelian anda di website
                                                        {{ config('app.site') }}
                                                        sebelum
                                                    ...
                                                    <table
                                                        ...
                                                        <tr>
                                                            <td>Pajak(PPN 10%)</td>
                                                            <td>:</td>
                                                            <td>{{ CurrencyHelper::rupiahCurrency($data['fees']) }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Total Pembayaran</td>
                                                            <td>:</td>
                                                            <td>{{ CurrencyHelper::rupiahCurrency($data['total_amount']) }}
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    ...
                                                    Jika anda merasa tidak melakukan hal tersebut, maka abaikan email
                                                    ini
                                                    <br><br>
                                                    <p
                                                        style="box-sizing:border-box;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Helvetica,Arial,sans-serif,'Apple Color Emoji','Segoe UI Emoji','Segoe UI Symbol';font-size:16px;line-height:1.5em;margin-top:0;text-align:left">
