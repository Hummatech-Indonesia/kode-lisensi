    ...
    <div class="col-sm-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{ route('faqs.update', $faq) }}" class="theme-form theme-form-2 mega-form"
                    ...
                    <div class="row">
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-10">
                                <input name="question" value="{{ $faq->question }}" autocomplete="off"
                        ...
                        <div class="mb-4 row align-items-center">
                            ...
                            <div class="col-sm-10">
                                <textarea name="answer" autocomplete="off"
                                          ...
                                          type="text"
                                          placeholder="Semua lisensi legal sebab kami beli langsung dari supplier besar.">{{ $faq->answer    }}</textarea>
                                @error('answer')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
