...
@section('content')
    <form enctype="multipart/form-data" method="POST" id="form" class="theme-form theme-form-2 mega-form"
        action="{{ route('varian.products.update', $product) }}">
        @csrf
        @method('PATCH')
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input id="sell_price_varian" min="0" autocomplete="off"
                                        name="sell_price_varian[]" class="form-control" type="text"
                                        placeholder="250000" value="{{ $varianProduct->sell_price }}">
                                </div>
                            </div>
                        </table>
