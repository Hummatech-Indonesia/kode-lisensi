                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="card-header-2">
                            <h5>Edit Sub Kategori {{ $articleName }}</h5>
                        </div>
                        ...
                        <form enctype="multipart/form-data"
                            action="{{ route('sub-article-categories.update',[$articleId, $subArticleCategory->id]) }}"
                            ...
                            <div class="mb-4 row align-items-center">
                                ...
                                <div class="col-sm-9">
                                    <input name="name" autocomplete="off" class="form-control" type="text"
                                        value="{{ $subArticleCategory->name }}" placeholder="Nama Kategori">
                                </div>
                            </div>
                            ...
                            <div class="mb-4 row align-items-center">
                                <div class="col-sm-6">
                                    ...
                                    <button class="btn btn-primary" type="submit"><i
                                            class="ri-add-line ri-1x me-2"></i>Simpan Perubahan
                                    </button>
                                </div>
                            </div>
                        </form>
