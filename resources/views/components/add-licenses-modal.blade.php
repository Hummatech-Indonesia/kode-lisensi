            ...
            <form action="" id="addLicenses" method="POST">
                ...
                <div class="modal-body m-3">
                    <div id="divUsername" class="mb-4 row align-items-center">
                        ...
                        <div class="col-sm-9">
                            <input id="addUsername" autocomplete="off" name="username" class="form-control"
                                type="text" placeholder="johndoe437@example.net">
                        </div>
                    </div>
                    <div id="divPassword" class="mb-4 row align-items-center">
                        <label class="form-label-title col-sm-3 mb-0">Password <span
                                class="text-danger">*</span></label>
                        <div class="col-sm-9">
                            <input id="addPassword" autocomplete="off" name="password" class="form-control"
                                type="text" placeholder="T2XiPgYmJ">
                        </div>
                    </div>
