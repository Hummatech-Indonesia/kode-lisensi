                    ...
                    <div id="productContainer"
                                ...
                                <div class="product-box-3 h-100 wow fadeInUp"
                                    ...
                                    <div class="product-footer">
                                        <div class="product-detail">
                                            ...
                                            <h5 class="price mt-3">
                                                @dd($product->varianProducts)
                                                @if ($product->detailTransactions)
                                                    <p>{{CurrencyHelper::countPriceAfterDiscount(CurrencyHelper::varianPrice($product->varianProducts), $product->discount, true)}}</p>
                                                @else
                                                    @auth
                        ...
                        @forelse($latestProducts as $product)
                            @if (!$product->transactions->isEmpty())
                                @forelse ($product->varianProducts as $varianProduct)
                                            ...
                                            <div class="product-footer">
                                                <div class="product-detail">
                                                    <div class="d-flex justify-content-between">
                                                        ...
                                                        <span class="span-name">{{$varianProduct->name}}</span>
                                                        @endif
                                                    </div>
                                                    <a href="{{ route('home.products.show', $product->slug) }}">
                                                        <h5 class="name">{{ $product->name }}</h5>
                                                    ...
                                                    <h6 class="unit">
                                                        <h4>
                                                            <span class="badge rounded-pill text-bg-success">{{$varianProduct->detailTransactions->count()}}</span>
                                                        </h4>
                                                    ...
                                                    <h5 class="price mt-3">
                                                        @if (!$product->varianProducts->isEmpty())
                                                            @auth
                                                                @if (UserHelper::getUserRole() == UserRoleEnum::RESELLER->value)
                                                                    <span
                                                                        class="theme-color">{{ CurrencyHelper::countPriceAfterDiscount($varianProduct->sell_price, $product->reseller_discount, true) }}</span>
                                                                    @if ($product->reseller_discount != 0)
                                                                        <del>{{ CurrencyHelper::rupiahCurrency($varianProduct->sell_price) }}</del>
                                                                    @endif
                                                                @else
                                                                    <span
                                                                        class="theme-color">{{ CurrencyHelper::countPriceAfterDiscount($varianProduct->sell_price, $product->discount, true) }}</span>
                                                                    @if ($product->discount != 0)
                                                                        <del>{{ CurrencyHelper::rupiahCurrency($varianProduct->sell_price) }}</del>
                                                                    @endif
                                                                @endif
                                        ...
                                        <div class="product-box-3 h-100 wow fadeInUp"
                                            ...
                                            <div class="product-footer">
                                                <div class="product-detail">
                                                    ...
                                                    <h6 class="unit">
                                                        <h4>
                                                            <span class="badge rounded-pill text-bg-success">{{$product->transactions->count()}}</span>
                                                        </h4>
                                                    </h6>
                                                    <h5 class="price mt-3">
                                                        @if (!$product->varianProducts->isEmpty())
