                    ...
                    <div class="breadscrumb-contain breadscrumb-order">
                        <div class="order-box">
                            ...
                            <div class="order-contain">
                                <h3 class="theme-color">Pembayaran Berhasil diverifikasi</h3>
                                <h5 class="text-content">Pembayaran anda
                                    sejumlah {{ CurrencyHelper::rupiahCurrency($transaction->paid_amount) }}
                                    berhasil
                                    kami terima dan akan segera diproses.
                                    Terimakasih.</h5>
                                <h6 class="mt-3">Transaction ID: {{ $transaction->invoice_id }}</h6>
                            </div>

                            <div class="order-contain mt-3">
                                <a href="{{ route('users.account.histories.index') }}"
                                   class="btn theme-bg-color btn-sm text-white fw-bold mt-md-4 mend-auto">Lihat
                                    Riwayat Transaksi</a>
                            </div>
                        </div>
                    </div>
