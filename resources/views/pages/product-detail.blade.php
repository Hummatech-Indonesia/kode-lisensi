                    ...
                    <div class="row g-4">
                                                ...
                                                <h3 class="theme-color price">
                                                    @if ($product->reseller_discount != 0)
                                                        <del class="text-content"
                                                            id="real-price-product">{{ CurrencyHelper::rupiahCurrency($product->varianProducts[0]->sell_price) }}</del>
                                                    @endif
                                                </h3>
                        ...
                        <div class="py-4">
                            ...
                            @auth
                                    ...
                                    @if ($roleReseller && $checkUser == null)
                                        <div class="d-flex">
                                            ...
                                            <form
                                                ...
                                                method="post">
                                                @csrf
                                                <input type="hidden" name="url" value="{{ $shareButtons['whatsapp'] }}"
                                                    id="">
                                                <button type="submit" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="" data-bs-original-title="Bagikan ke whatsapp"
                                                    class="mx-1" style="border: none; background:transparent; padding:0;">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                            ...
                                            <form
                                                ...
                                                method="post">
                                                @csrf
                                                <input type="hidden" name="url" value="{{ $shareButtons['facebook'] }}"
                                                    id="">
                                                <button type="submit" data-bs-toggle="tooltip" data-bs-placement="top"
                                            ...
                                            <form
                                                ...
                                                method="post">
                                                @csrf
                                                <input type="hidden" name="url" value="{{ $shareButtons['telegram'] }}"
                                                    id="">
                                                <button type="submit" data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="" data-bs-original-title="Bagikan ke telegram"
                                                    class="mx-1" style="border: none; background:transparent; padding:0;">
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                        style="color: #1C93E3" fill="currentColor" class="bi bi-telegram"
                                                        viewBox="0 0 16 16">
                                                        <path
                                ...
                                @else
                                    <div class="">
                                        <a class="mx-1" id="copyButton" style="cursor: pointer" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="" data-bs-original-title="Salin Tautan">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                                fill="currentColor" class="bi bi-copy" viewBox="0 0 16 16">
                                                <path fill-rule="evenodd"
                                                    d="M4 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 5a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h8a1 1 0 0 0 1-1v-1h1v1a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h1v1z" />
                                        ...
                                        <a href="{{ $shareButtons['whatsapp'] }}" target="__blank" data-bs-toggle="tooltip"
                            ...
                            @guest
                                <div class="">
                                    ...
                                    <a href="{{ $shareButtons['whatsapp'] }}" target="__blank" data-bs-toggle="tooltip"
                                        data-bs-placement="top" title="" data-bs-original-title="Bagikan ke whatsapp"
                                        class="mx-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                            style="color: green" style="margin: 3px" fill="currentColor"
                                            class="bi bi-whatsapp" viewBox="0 0 16 16">
                    ...
                    <ul class="nav nav-tabs custom-nav" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="question-tab" data-bs-toggle="tab" data-bs-target="#question"
                                type="button" role="tab" aria-controls="question" aria-selected="false">Pertanyaan
                            </button>
                        </li>
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="review-tab" data-bs-toggle="tab" data-bs-target="#review"
                                type="button" role="tab" aria-controls="review" aria-selected="false">Ulasan
                                Pelanggan
                            </button>
                        </li>
                    </ul>
                    ...
                    <div class="tab-content custom-tab" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="review" role="tabpanel" aria-labelledby="review-tab">
                            <div class="review-box">
                                <div class="row g-4">
                                    <form method="POST" action="{{ route('user.addOrUpdateRating', $product->id) }}">
                                        @csrf
                                        @auth
                            ...
                            @foreach ($recommendProducts as $product)
                                <li>
                                    <div class="offer-product">
                                        <a href="{{ route('home.products.show', $product->slug) }}" class="offer-image">
    ...
    <script>
        $(document).ready(function() {
            $('.varian-product').click(function() {
                ...
                var discount = parseFloat($(this).data(
                    'discount'));
                var currentPrice = formatCurrency(countPriceAfterDiscount(sellPrice, discount));
                var slug = $(this).data('slug');
                $("#buy-product-varian").attr("href", "{{ route('checkout', [$product->slug, '']) }}/" +
                    slug);

                $('#price-product').text(currentPrice);
                $('#real-price-product').text(formattedPrice);
            });
            ...
            function countPriceAfterDiscount(price, discount) {
