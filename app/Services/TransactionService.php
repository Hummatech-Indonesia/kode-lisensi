...
class TransactionService
{
    ...
    public function __construct(TransactionInterface $transaction, LicenseInterface $license, TripayService $service, FcmTokenInterface $fcmToken, VarianProductInterface $varianProduct, UpdateIdInvoiceInterface $updateIdInvoice, TransactionAffiliateService $transactionAffiliateService)
    {
     ...
     * @return void
     */
    public function handleCheckoutAffiliate(TransactionRequest $request, Product $product, string $slug_varian = null, mixed $code_affiliate): void
    {
        $data = $request->validated();
        ...
        $this->transactionAffiliateService->store($transaction, $code_affiliate, $product, $slug_varian);
